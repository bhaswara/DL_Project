...
def camera():
	...
	while True:
		...
		fake_B_array = cv2.resize(fake_B_array, (640, 360)) 
...
def image_process():
	...
	cv2.imshow('Test', fake_B_array)
	cv2.imwrite('result.jpg', fake_B_array_adjust)
